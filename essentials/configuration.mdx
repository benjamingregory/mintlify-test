...
The Context selector determines what information Coplay has access to when responding to your queries:
...
The Mode selector lets you select specialized AI modes optimized for different tasks:
