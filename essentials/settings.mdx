...
You can also manage custom rules through the "Edit Custom Coplay Rules" button, which opens a dialog enabling you to create specialized instructions for Coplay that will be saved to `.coplayrules.md` in your project root folder.
