...
**Example usage**: Create custom rules like "Always comment public methods" or "Follow our team's naming convention" to ensure Coplay adheres to your project standards. You can also reference other files if you have pre-existing instructions / best practices: "Before any task is started, read handovernotes.md to understand the dependencies and context of the project you are working on."